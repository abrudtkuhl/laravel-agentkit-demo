...
- Determine next version: Check latest tag with `git describe --tags --abbrev=0` and increment (e.g., patch for fixes, minor for features)
...
5. Clean up and tag release
6. Update Changelog to make the changes released on the current date
